...
lcg-cp --vo cosmo lfn:$COSMO_ROOT/${LOCUS_ALGORITHM_DIR}/locus_algorithm_6_3 file:${LOCUS_ALGORITHM_DIR}/locus_algorithm_6_3

#and makes it executable
chmod 755 ${LOCUS_ALGORITHM_DIR}/locus_algorithm_6_3
...
./${LOCUS_ALGORITHM_DIR}/locus_algorithm_6_3  ${PPR_FILE} ${COLOUR} &>/dev/null
