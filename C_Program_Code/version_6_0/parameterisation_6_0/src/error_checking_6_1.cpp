//============================================================================
// Name        : error_checking_6_1.cpp
// Author      : Oisin Creaner
// Date		   : 31st March 2011
// Copyright   : (c) Oisin Creaner, ITT Dublin 2011
...
int error_checking (int error)
{
	...
	{
		//commented out no error error message.
	...
	else if (error == ERR_TOO_MANY_ARGS)
	{
		printf ("\nToo many arguments submitted to the job!\n");
		
		return (error);
	}
	else if (error == ERR_WRONG_FILE_TYPE)
	{
		printf ("\nFile type input is wrong!\n");
